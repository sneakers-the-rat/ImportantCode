 ...
 * 
 * This module defines standard data types compatible with C/C# syntax and dynamic type inference,
 * allowing for robust schema mapping across diverse database schemas without manual casting logic.
 */
